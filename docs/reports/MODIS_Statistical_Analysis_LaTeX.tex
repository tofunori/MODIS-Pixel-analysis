...
\begin{itemize}
    \item \textbf{Length:} Approximately 13 km, making it the longest glacier flowing from the Columbia Icefield \cite{wikipedia_saskatchewan_2024}
    \item \textbf{Area:} 30 km² of ice coverage \cite{wikipedia_saskatchewan_2024}
    \item \textbf{Thickness:} Over 400 m thick at 8 km from the terminus (measured in 1960) \cite{wikipedia_saskatchewan_2024}
    \item \textbf{Elevation:} Flows from the Continental Divide down to approximately 1,800 m
    \item \textbf{Hydrological Significance:} Primary source for the North Saskatchewan River \cite{wikipedia_saskatchewan_2024}
\end{itemize}

\subsection{Research Context and Previous Studies}

Saskatchewan Glacier has been subject to extensive glaciological research since the late 19th century \cite{wikipedia_saskatchewan_2024}. Historical records document significant retreat patterns: between 1893 and 1953, the glacier retreated 1,364 m, with accelerating retreat rates of 55 m per year between 1948--1953 \cite{wikipedia_saskatchewan_2024}. Recent modeling studies \cite{marshall_modelling_2022} demonstrate that albedo feedback accounts for 44\% of the glacier's mass balance response to climate warming, making albedo monitoring critically important for understanding glacier dynamics.
